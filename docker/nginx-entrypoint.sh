...
DEV_SERVER_NAME_RAW="${DEV_HTTPS_HOSTS:-raspissd.local localhost}"
DEV_SSL_CERT_PATH="${DEV_SSL_CERT_PATH:-/etc/nginx/dev-certs/raspissd.local.pem}"
DEV_SSL_KEY_PATH="${DEV_SSL_KEY_PATH:-/etc/nginx/dev-certs/raspissd.local-key.pem}"
