...
from .gtk_helpers import create_combo_with_entry
...
class LocWidget(Gtk.VBox):
    def __init__(self,default=False):
        ...
        self.country_combo = create_combo_with_entry(liststore, text_column=0)
    ...
    def on_count_selected(self,combo):
        ...
        if not iter: return
        model = combo.get_model()
        code = model.get_value(iter,1)  # Already a str in Python 3
        liststore = Gtk.ListStore(str,str)
