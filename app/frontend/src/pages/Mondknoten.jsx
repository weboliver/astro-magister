...
export default function Mondknoten() {
  const state = useInterpretationPage({
    graphicEndpoint: '/nodes/graphic',
    cacheKeyPrefix: 'nodes',
  })
  ...
  return (
    <InterpretationPage
      title="Mondknoten"
      wikiPageName="Mondknoten"
      wikiOriginPage="mondknoten"
      wikiOriginLabel="Mondknoten"
      historyContextType="nodes"
      interpretButtonLabel="Mondknoten interpretieren"
      interpretButtonLoadingLabel=""
      chartLoadingMessage="Mondknoten wird gerendert…"
      chartFallbackMessage="Klicke auf «Mondknoten interpretieren», um das Chart rechts neben dem Formular anzuzeigen und eine Auswertung zu erhalten."
